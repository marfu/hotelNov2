...
//				u.getPvt().size();
    ...
    public List<ReservationDto> getAllReservation() {
        ...
        try {
            List<Object[]> resultObject = (List<Object[]>) em.createNativeQuery("SELECT r.TRES_NUM_RESERVATION,r.TRES_DATE_CREATE,cli.TCLI_NOM,cli.TCLI_PRENOM,cli.TCLI_RAISON_SOCIALE,cli.TCLI_MSISDN,cli.TCLI_ID,r.TRES_ID,r.TRES_ETAT FROM t_reservation r,t_client cli where cli.TCLI_ID=r.TRES_CLIENT_ID order by r.TRES_DATE_CREATE desc").getResultList();
