...
public class TChambreService {
    ...
    public TChambre CreerTChambreDao(String chLib, String chNumeroChambre, TCategorieChambre chCategorie,Date chDateCreate,EtatChambreEnum etat) {
     ...
     public InfoChambreDto findDetailsChambre(long id,Date dateDebut,Date dateFin) {
      ...
      public InfoChambreDto findChambreOccupee(long id,Date dateDebut,Date dateFin) {
      
        return  tChambreDao.findChambreOccupee(id,dateDebut,dateFin);
    }
      
      public InfoChambreDto findChambreReservee(long id,Date dateDebut,Date dateFin) {
      
        return  tChambreDao.findChambreReservee(id, dateDebut, dateFin);
    }
    ...
    public List<TChambre> listChambreByEtatAndCat(EtatChambreEnum etat,long id) {
        return tChambreDao.findDetailsChambreByEtatAndCat(etat, id);

    }
    
     public List<TChambre> listChambreByCat(Long id) {
        return tChambreDao.findChambreCategorie(id);
