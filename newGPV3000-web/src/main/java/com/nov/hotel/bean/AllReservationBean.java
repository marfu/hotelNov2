...
public class AllReservationBean implements Serializable {
    ...
    public Date getDebutOcc() {
        return debutOcc;
    }
    
    public void setDebutOcc(Date debutOcc) {
        this.debutOcc = debutOcc;
    }
    
    public Date getFinOcc() {
        return finOcc;
    }
    
    public void setFinOcc(Date finOcc) {
        this.finOcc = finOcc;
    }
    ...
    public void ajouterOccupant(ActionEvent actionEvent) {
        ...
        dto.setDateDeb(debutOcc);
        dto.setDateFin(finOcc);
...
//
        ...
        tempDTO.setDateDeb(debutOcc);
        tempDTO.setDateFin(finOcc);
    ...
    public void valider() {
        ...
        if (listChambresDto.size() == 0) {
            ...
            List<TChambreReservation> tchReser = tChambreReservationService.listOffreTarifaireByCategorie(reservation.getResId());
...
//                tch.setEtat(EtatChambreEnum.RESERVEE);
            ...
            context.addMessage(null, new FacesMessage("Success", "Votre Modification a été prise en compte"));
            // clearEntity();
        }
    ...
    public String confirmerReservation() {
        ...
        if (testOccupantChambre == true) {
            ...
            for (OccupantDto str : occupantDto) {
                ...
                u.setOccDateDep(str.getDateFin());
                u.setOccDateArr(str.getDateFin());
...
//        
    ...
    public void findClient() {
        ...
        System.out.println("clientxxxxxxxxx==========="+ clientOcc.getNumeroPieceIdentite());
